...
class SeeAllSubjects extends StatefulWidget {
  SeeAllSubjects({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SeeAllSubjectsState createState() => _SeeAllSubjectsState();
}

class _SeeAllSubjectsState extends State<SeeAllSubjects> {
